...
Prompt: Draw a stylized course introduction card for Canvas [course]: 262x146 (1.79:1 ratio). Text centered at bottom, 10% padding (margin to edge), large bold san-serif text (2x standard size): "Course Title <em>A/B</em>"; no watermark.
